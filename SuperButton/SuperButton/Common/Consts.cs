...
namespace SuperButton.Common
{
    public class Consts
    {
        ...
        private Dictionary<int, string> dic_paths = new Dictionary<int, string>()
                                                                   {
                                                                       {KEY_HISTORY_DIR,Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Redler\\SuperMotorController_Params"},
                                                                       {KEY_PARAMS_DIR, Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Redler\\SuperMotorControllerHistory"}
                                                                   };
